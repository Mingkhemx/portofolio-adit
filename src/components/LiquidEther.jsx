  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        // Cap pixelRatio to 1.0 on mobile and 1.5 on desktop to drastically reduce GPU fill-rate workload on high-DPI/AMOLED screens
        this.pixelRatio = window.innerWidth < 1024 ? 1.0 : Math.min(window.devicePixelRatio || 1, 1.5);
        this.resize();
    ...
    class MouseClass {
      ...
      init(container) {
        ...
        // DISABLED user interaction so it only runs on autoDemo
